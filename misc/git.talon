...
git log long: "git log "
git log: "clear && git log --graph --decorate --oneline --all\n"
...
git rebase development: "git rebase dev "
...
git reset (mix|mixed): "git reset --mixed\n"
...
git switch development: "git switch dev "
